...
import { HOME_ROUTE, MORE_ROUTES } from '@/util/consts'
import { useEffect } from 'react'

const queryClient = new QueryClient()
const MoreMeta: Meta<typeof MoreMoviesSeries> = {
  title: 'Pages/More',
  component: MoreMoviesSeries,
  decorators: (Story) => {
    return (
  ...
  beforeEach: () => {
    ...
    url.pathname = MORE_ROUTES.RECOMMENDATION.path
...
export default MoreMeta
export const Default: StoryObj<typeof MoreMeta> = {}
