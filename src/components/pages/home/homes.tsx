...
export function Home() {
    ...
    return (
        <section className="flex flex-col gap-6">
            <MoviesInFocus />
            <SectionMoviesAndSeries year={2022} page={1} title="Lançamentos" type=""/>
