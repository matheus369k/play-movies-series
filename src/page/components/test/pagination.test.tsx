...
interface PropsMock {
  ...
  setMoviesInfoWithPagination?:
    | React.Dispatch<React.SetStateAction<TMoviesInfoWithPagination>>
    | undefined;
}
...
const renderComponentPagination = (currentPage: number) => {
  ...
  spyState.mockImplementationOnce(() => [
    moviesInfoWithPagination,
    setMoviesInfoWithPagination,
  ]);
...
describe("Pagination Component", () => {
  ...
  it("clicking to next 1 page", () => {
    const { moviesInfoWithPagination, setMoviesInfoWithPagination } =
  ...
  it("clicking to initial page", () => {
    ...
    expect(mockHandlePassToStartPage.mock.lastCall[0]).toEqual({
      moviesInfoWithPagination,
      setMoviesInfoWithPagination,
    });
  });
  ...
  it("clicking to end page", () => {
    ...
    expect(mockHandlePassToEndPage.mock.lastCall[0]).toEqual({
      moviesInfoWithPagination,
      setMoviesInfoWithPagination,
    });
  });
